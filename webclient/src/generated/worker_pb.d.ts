...
export class PostWorkerRequest extends jspb.Message {
  hasWorker(): boolean;
  clearWorker(): void;
  getWorker(): WorkerModel | undefined;
  setWorker(value?: WorkerModel): void;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): PostWorkerRequest.AsObject;
  static toObject(includeInstance: boolean, msg: PostWorkerRequest): PostWorkerRequest.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: PostWorkerRequest, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): PostWorkerRequest;
  static deserializeBinaryFromReader(message: PostWorkerRequest, reader: jspb.BinaryReader): PostWorkerRequest;
}

export namespace PostWorkerRequest {
  export type AsObject = {
    worker?: WorkerModel.AsObject,
  }
}
